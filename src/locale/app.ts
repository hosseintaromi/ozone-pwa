const app = {
  ...
  purchaseDetail: {
    ...
    selectMerchantYouBuy: 'فروشگاه مورد نظر را که از آن خرید کرده اید را انتخاب کنید.',
  },
  chooseWallet: {
    title: 'انتخاب حساب',
  ...
  helpDialog: {
    title: 'راهنمای اوزون',
    subTitle: 'گزینه مورد نظر را جهت راهنما اوزون انتخاب کنید.',
    app: 'استفاده از برنامه',
    inpersion: 'خرید حضوری',
    online: 'خرید آنلاین',
  },
  daily: 'روزانه',
  monthly: 'ماهانه',
  ...
  setting: {
    ...
    exit: 'خروج از برنامه',
    exitHint: 'آیا می خواهید از برنامه خارج شوید؟',
    version: 'نسخه 0.0.8',
  },
  kyc: {
    title: 'احراز هویت',
