...
import { BUTTON_TYPE, ButtonType, VARIANT_ENUM } from '@/@types';

import { COLOR_ENUM, SIZE_ENUM } from '../@helpers/types';
  ...
  return (
    <button
      ...
      className={cn(
        ...
        size === SIZE_ENUM.MD && 'h-8 px-3 py-1.5 text-[14px] leading-5',
        ...
        variant === VARIANT_ENUM.DEFAULT &&
          'bg-secondary hover:bg-secondary/80 focus:ring-0 focus:ring-opacity-50',
        variant === VARIANT_ENUM.TEXT && 'text-secondary  hover:bg-secondary/10 focus:ring-0',
        color === COLOR_ENUM.PRIMARY &&
          variant === VARIANT_ENUM.DEFAULT &&
        ...
        color === COLOR_ENUM.WHITE &&
          variant === VARIANT_ENUM.OUTLINED &&
          'border-neutral-0 text-white hover:bg-primary',
        color === COLOR_ENUM.LIGHT_GRAY &&
          variant === VARIANT_ENUM.OUTLINED &&
          'border-neutral-500 text-gray-200 hover:bg-primary',
